...
const helper = new PositionalAudioHelper(sound1)
sound1.add(helper)
...
function animate() {
	...
	updateVolumeBasedOnDistance(sound1, listenerPosition, 20, 1)
